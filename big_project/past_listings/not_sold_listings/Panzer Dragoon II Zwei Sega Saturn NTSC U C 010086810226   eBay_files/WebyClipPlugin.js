...
//loadScript( webyclipCdnCodeBaseUrl + "/jquery.tools.min.js", scriptLoadHandler);
	...
	#" + targetId + " .jcarousel-skin-wc .jcarousel-item-horizontal { margin-left: 0;	margin-right: 5px; padding: 0px;}\n\
...
@media only screen and (min-device-width : 320px) and (max-device-width : 550px) {\n\
	...
	#" + targetId + " .jcarousel-skin-wc .jcarousel-item-horizontal { margin-left: 0;	margin-right: 3px; padding:0px;}\n\
...
@media only screen and (min-device-width : 320px) and (max-device-width : 550px) {\n\
	...
	div.wc-fixed-pannel-s-w {  bottom: 10px; left: 10px; }\n\
                ...
                $("#" + $target.attr('id') + " .webyclipAddMediaLink").click(function() {
                    ...
                    window.open(webyclipBaseUrl + '/addmedia.php?_m=default&_dse=' + dse + getRequestData(prodIndex), "webyclipAddMedia", "top=" + y + ",left=" + x + ",status=0,toolbar=0,location=0,menubar=0,directories=0,resizable=0,titlebar=0,height=465,width=720", false);
                    return false;
                });
                $("#" + $target.attr('id') + " .webyclipAddPrivateMediaLink").click(function() {
                    ...
                    window.open(webyclipBaseUrl + '/addmedia.php?_m=default&_p5=' + p5 + '&_dse=' + dse + getRequestData(prodIndex), "webyclipAddMedia", "top=" + y + ",left=" + x + ",status=0,toolbar=0,location=0,menubar=0,directories=0,resizable=0,titlebar=0,height=465,width=720", false);
                    return false;
                });
